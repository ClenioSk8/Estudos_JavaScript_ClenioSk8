...
class Investidor {
    ...
    calcularRentabilidade() {
        ...
        const total_rentabilidade = (this.aporteMensalRendaFixa * this.tempoInvestimento) / 100 * 13.25
        const acumulado_final = total_investido + total_rentabilidade
        const imposto_seis_meses = total_rentabilidade - (total_rentabilidade / 100 * 22).toFixed(2)
        const imposto_7_meses = total_rentabilidade - (total_rentabilidade / 100 * 20).toFixed(2)
        const imposto_12_meses = total_rentabilidade - (total_rentabilidade / 100 * 17).toFixed(2)


        if (this.tempoInvestimento >= 12) {
            console.log(total_rentabilidade - (total_rentabilidade / 100 * 17).toFixed(2));
        } else if (this.tempoInvestimento > 7) {
            console.log(total_rentabilidade - (total_rentabilidade / 100 * 20).toFixed(2));
        } else if (this.tempoInvestimento >= 6) {
            console.log(total_rentabilidade - (total_rentabilidade / 100 * 22).toFixed(2));
        }
